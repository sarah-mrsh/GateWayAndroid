...
public class TagListTCPViewAdapter extends RecyclerView.Adapter<TagListTCPViewAdapter.ViewHolder> {


    List<I4AllSetting> data = new ArrayList<>();
    Context context;

    public TagListTCPViewAdapter(List<I4AllSetting> data, Context context) {
        this.data = data;
