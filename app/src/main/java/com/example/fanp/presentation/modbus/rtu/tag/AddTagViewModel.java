...
//    public String description;
    ...
    public void savedata() {
        ...
        data = db.getitembyitesref(AddTag.item.getAllSettingId());
        try {
            ...
            JSONArray array = new JSONArray(AddTag.item.getItemsData());
            JSONObject jsonObject = array.getJSONObject(AddTag.index);
